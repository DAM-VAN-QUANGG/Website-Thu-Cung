        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary">
                    ...
                    <form method="POST" action="<?= BASE_URL_ADMIN . '?act=sua-san-pham' ?>"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (is_array($sanPham['hinh_anh'])): ?>
                                    <img src="<?= BASE_URL . $sanPham['hinh_anh'][0] ?>" alt="Hình ảnh sản phẩm"
                                        width="100">
                                <?php else: ?>
                                ...
                                <select id="inputStatus" name="danh_muc_id" class="form-control custom-select">
                                    <?php foreach ($listDanhMuc as $danhMuc): ?>
                                        <option <?= $danhMuc['id'] == $sanPham['danh_muc_id'] ? 'selected' : '' ?>
                                            value=" <?= $danhMuc['id']; ?>"> <?= $danhMuc['ten_danh_muc']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card-body p-0">
                    <form method="POST" action="<?= BASE_URL_ADMIN ?>?act=sua-album-anh-san-pham"
                        enctype="multipart/form-data">
