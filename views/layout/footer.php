                    ...
                    <div class="widget-item">
                        ...
                        <div class="widget-body">
                            <address class="contact-block">
                                <ul>
                                    <li><i class="pe-7s-home"></i>Đường Trịnh Văn Bô, Nam Từ Liêm, Hà Nội</li>
                                    <li><i class="pe-7s-mail"></i> <a
                                            href="mailto:demo@plazathemes.com">minhnhat123@gmail.com</a></li>
                                    <li><i class="pe-7s-call"></i> <a href="tel:(012)800456789987">0334773002</a></li>
                                </ul>
                            </address>
                        </div>
                    </div>
