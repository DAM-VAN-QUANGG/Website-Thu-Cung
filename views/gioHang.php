                                        ...
                                        <tr>
                                            ...
                                            <td class="pro-subtotal">
                                                <span>
                                                    ...
                                                    // Đảm bảo $tongGioHang được khởi tạo trước khi cộng thêm $tongTien
                                                    if (!isset($tongGioHang)) {
                                                        $tongGioHang = 0; // Khởi tạo $tongGioHang nếu chưa được định nghĩa
                                                    }

                                                    $tongGioHang += $tongTien; // Cộng thêm giá trị vào $tongGioHang
                                                    echo formatPrice($tongTien) . ' đ'; // Hiển thị tổng tiền của sản phẩm
                                                    ?>
                                                </span>
                                            </td>
